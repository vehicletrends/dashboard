...
All charts separate new and used vehicle markets, showing trends from 2018-2024. The "Summary Over Time" section highlights changes between 2018 and 2024, while the "Overall Trends" section displays year-by-year changes. The remaining sections show how these variables interact with each other (e.g., how powertrain distribution varies across different vehicle types).
...
<center>
[Download data](`r url_percent_listings`)
