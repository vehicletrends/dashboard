...
This app helps explain the meaning of the [Herfindahl–Hirschman Index (HHI)](https://en.wikipedia.org/wiki/Herfindahl%E2%80%93Hirschman_index), which is an index from 0 to 1 that helps explain the level of concentration in a market.
